...
import {
  ...
  useAccordionButton
} from "./chunk-CMC7W7SH.js";
import {
  require_browser,
  useMergedRefs_default,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-MKJ3DBAK.js";
import {
  ENTERED,
  ENTERING,
  EXITING,
...
import {
  ...
  map,
  useCol
} from "./chunk-6CMSHL7V.js";
import {
  require_warning
} from "./chunk-EN6RKABF.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Alert = React7.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
...
function useUpdateEffect(fn2, deps) {
  const isFirst = (0, import_react14.useRef)(true);
...
function useWillUnmount(fn2) {
  ...
  (0, import_react16.useEffect)(() => () => onUnmount.current(), []);
}
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react19.useCallback)((...args) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react23.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context4 = (0, import_react28.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var context2 = React40.createContext(null);
...
var InputGroup = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime52.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames40.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react34.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react35.useRef)(inProp);
  ...
  const child = (0, import_react35.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useTransition({
  ...
  const isInitialRef = (0, import_react36.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react36.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react36.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime53.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
    return (0, import_jsx_runtime53.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime53.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react37.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react37.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react37.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react37.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime54.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react37.useState)(!show);
  const lastFocusRef = (0, import_react37.useRef)(null);
  (0, import_react37.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react37.useRef)();
  const removeKeydownListenerRef = (0, import_react37.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime54.jsx)("div", Object.assign({}, dialogProps, {
    children: React53.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime54.jsx)(import_jsx_runtime55.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime56.jsxs)(import_jsx_runtime55.Fragment, {
...
var ModalContext = React55.createContext({
...
var ModalDialog = React56.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React57.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React58.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context4 = (0, import_react38.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime61.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime60.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var Modal2 = React61.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react39.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react39.useState)(false);
  const waitingForMouseUpRef = (0, import_react39.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react39.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react39.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react39.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react39.useCallback)((backdropProps) => (0, import_jsx_runtime64.jsx)("div", {
    ...backdropProps,
...
var NavItem = React62.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav = React64.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react40.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react40.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React66.forwardRef(({
  ...
  const context4 = (0, import_react41.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime69.jsx)(Collapse_default, {
...
var NavbarToggle = React67.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime70.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react43.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react44.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasToggling = React69.forwardRef(({
  ...
  return (0, import_jsx_runtime72.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var Offcanvas = React72.forwardRef(({
  ...
  const modalManager = (0, import_react45.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react45.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react45.useState)(false);
  ...
  const renderBackdrop = (0, import_react45.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames56.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames56.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
var NavbarOffcanvas = React73.forwardRef((props, ref) => {
  const context4 = (0, import_react46.useContext)(NavbarContext_default);
...
var Navbar = React75.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react47.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react47.useMemo)(() => ({
  ...
  return (0, import_jsx_runtime80.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime80.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime80.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames58.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React76.forwardRef(({
  ...
  return (0, import_jsx_runtime82.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames59.default)(className, navItemPrefix),
...
var Overlay = React77.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react49.useState)(!props.show);
...
var Popover = React81.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsxs)("div", {
    ...
    className: (0, import_classnames62.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Tooltip = React82.forwardRef(({
  ...
  return (0, import_jsx_runtime88.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames63.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
var Overlay2 = React83.forwardRef(({
  ...
  const popperRef = (0, import_react51.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react51.useState)(null);
  ...
  return (0, import_jsx_runtime89.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React83.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames64.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react52.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react52.useRef)("");
  ...
  const handleShow = (0, import_react52.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react52.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react52.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react52.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react52.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react52.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react52.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(import_jsx_runtime91.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react52.cloneElement)(children, triggerProps), (0, import_jsx_runtime90.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime93.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames65.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime94.jsxs)(Component2, {
      className: (0, import_classnames65.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React85.forwardRef(({
    children,
    ...props
...
var Pagination = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames66.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames67.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames68.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var ProgressBar = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react53.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)("div", {
    ...
    className: (0, import_classnames69.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime100.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames70.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime101.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames71.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React93.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime103.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime102.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime102.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
var Stack = React94.forwardRef(({
  ...
  return (0, import_jsx_runtime104.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames72.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context4, rest = _objectWithoutPropertiesLoose6(context4, _excluded22);
    ...
    return (0, import_jsx_runtime105.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime105.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime105.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime105.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime107.jsx)(Tabs_default, {
  ...props,
    ...
    children: (0, import_jsx_runtime109.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime109.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime109.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames74.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React100.forwardRef(({
  ...
  const classes = (0, import_classnames75.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime110.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime111.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastFade = React102.forwardRef((props, ref) => (0, import_jsx_runtime113.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React104.forwardRef(({
  ...
  const context4 = (0, import_react56.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime115.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames76.default)(bsPrefix, className),
...
var Toast = React106.forwardRef(({
  ...
  const delayRef = (0, import_react57.useRef)(delay);
  const onCloseRef = (0, import_react57.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react57.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react57.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  const toast = (0, import_jsx_runtime117.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames78.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React107.forwardRef(({
  ...
  return (0, import_jsx_runtime118.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames79.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var ToggleButton = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [(0, import_jsx_runtime119.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames80.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
