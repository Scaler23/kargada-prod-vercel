...
var require_const = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/const.js"(exports) {
    "use strict";
...
var require_bootstrap = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/bootstrap.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_symbol = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/sort/symbol.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _react = require_react();
    var _react2 = _interopRequireDefault(_react);
    var _bootstrap = require_bootstrap();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var SortSymbol = function SortSymbol2() {
...
var require_caret = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/sort/caret.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var SortCaret = function SortCaret2(_ref) {
...
var require_underscore = __commonJS({
  "node_modules/underscore/underscore.js"(exports, module) {
    (function() {
      ...
      _.object = function(list, values2) {
        var result = {};
        for (var i = 0, length = getLength(list); i < length; i++) {
          if (values2) {
            result[list[i]] = values2[i];
          } else {
...
var require_utils = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _underscore = require_underscore();
    ...
    function get(target, field) {
      ...
      if (directGet !== void 0 && directGet !== null) {
        return directGet;
      }
    ...
    function set(target, field, value) {
      var safe = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
      var pathArray = splitNested(field);
      var level = 0;
      pathArray.reduce(function(a, b) {
        ...
        if (typeof a[b] === "undefined") {
          if (!safe)
            throw new Error(a + "." + b + " is undefined");
          a[b] = {};
          return a[b];
        }
...
var require_cell_event_delegater = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/cell-event-delegater.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return function(_ExtendBase) {
        ...
        _createClass(CellEventDelegater, [{
          ...
          value: function createDefaultEventHandler(cb) {
            var _this2 = this;
            return function(e) {
              var _props = _this2.props, column = _props.column, columnIndex = _props.columnIndex, index = _props.index;
...
var require_header_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/header-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _caret = require_caret();
    var _caret2 = _interopRequireDefault(_caret);
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    var _cellEventDelegater = require_cell_event_delegater();
    ...
    var HeaderCell = function(_eventDelegater) {
      _inherits(HeaderCell2, _eventDelegater);
      function HeaderCell2() {
        _classCallCheck(this, HeaderCell2);
        return _possibleConstructorReturn(this, (HeaderCell2.__proto__ || Object.getPrototypeOf(HeaderCell2)).apply(this, arguments));
      }
      _createClass(HeaderCell2, [{
        key: "render",
        value: function render() {
          var _props = this.props, column = _props.column, index = _props.index, onSort = _props.onSort, sorting = _props.sorting, sortOrder = _props.sortOrder, isLastSorting = _props.isLastSorting, onFilter = _props.onFilter, currFilters = _props.currFilters, filterPosition = _props.filterPosition, onExternalFilter = _props.onExternalFilter, globalSortCaret = _props.globalSortCaret;
          var text = column.text, sort = column.sort, sortCaret = column.sortCaret, filter = column.filter, filterRenderer = column.filterRenderer, headerTitle = column.headerTitle, headerAlign = column.headerAlign, headerFormatter = column.headerFormatter, headerEvents = column.headerEvents, headerClasses = column.headerClasses, headerStyle = column.headerStyle, headerAttrs = column.headerAttrs, headerSortingClasses = column.headerSortingClasses, headerSortingStyle = column.headerSortingStyle;
          ...
          var cellAttrs = _extends2({}, customAttrs, delegateEvents, {
          ...
          if (headerStyle) {
            ...
            cellStyle = cellStyle ? _extends2({}, cellStyle) : cellStyle;
          }
          if (headerTitle) {
          ...
          if (sort) {
            ...
            cellAttrs.onKeyUp = function(e) {
              if (e.key === "Enter") {
                onSort(column);
                if (_utils2.default.isFunction(customClick))
                  customClick(e);
              }
            };
            ...
            if (sorting) {
              ...
              cellStyle = _extends2({}, cellStyle, _utils2.default.isFunction(headerSortingStyle) ? headerSortingStyle(column, sortOrder, isLastSorting, index) : headerSortingStyle);
            } else {
              sortSymbol = sortCaretfunc ? sortCaretfunc(void 0, column) : _react2.default.createElement(_symbol2.default, null);
            }
          }
          if (cellClasses)
            cellAttrs.className = (0, _classnames2.default)(cellAttrs.className, cellClasses);
          if (!_utils2.default.isEmptyObject(cellStyle))
          ...
          if (filterPosition === _const2.default.FILTERS_POSITION_INLINE) {
            if (filterRenderer) {
              ...
              filterElm = _react2.default.createElement(filter.Filter, _extends2({}, filter.props, {
          ...
          var children2 = headerFormatter ? headerFormatter(column, index, { sortElement: sortSymbol, filterElement: filterElm }) : text;
          if (headerFormatter) {
            return _react2.default.createElement("th", cellAttrs, children2);
          }
          return _react2.default.createElement("th", cellAttrs, children2, sortSymbol, filterElm);
        }
      }]);
      return HeaderCell2;
...
var require_selection_header_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-selection/selection-header-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var CheckBox = exports.CheckBox = function CheckBox2(_ref) {
      var className = _ref.className, checked = _ref.checked, indeterminate = _ref.indeterminate;
    ...
    var SelectionHeaderCell = function(_Component) {
      _inherits(SelectionHeaderCell2, _Component);
      function SelectionHeaderCell2() {
        _classCallCheck(this, SelectionHeaderCell2);
        var _this = _possibleConstructorReturn(this, (SelectionHeaderCell2.__proto__ || Object.getPrototypeOf(SelectionHeaderCell2)).call(this));
        _this.handleCheckBoxClick = _this.handleCheckBoxClick.bind(_this);
        return _this;
      }
      _createClass(SelectionHeaderCell2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
          var ROW_SELECT_SINGLE = _const2.default.ROW_SELECT_SINGLE;
          var _props = this.props, mode = _props.mode, checkedStatus = _props.checkedStatus;
        ...
        value: function handleCheckBoxClick(e) {
          var _props2 = this.props, onAllRowsSelect = _props2.onAllRowsSelect, checkedStatus = _props2.checkedStatus;
        ...
        value: function render() {
          var _this2 = this;
          var CHECKBOX_STATUS_CHECKED = _const2.default.CHECKBOX_STATUS_CHECKED, CHECKBOX_STATUS_INDETERMINATE = _const2.default.CHECKBOX_STATUS_INDETERMINATE, ROW_SELECT_MULTIPLE = _const2.default.ROW_SELECT_MULTIPLE;
          var _props3 = this.props, mode = _props3.mode, checkedStatus = _props3.checkedStatus, selectionHeaderRenderer = _props3.selectionHeaderRenderer, hideSelectAll = _props3.hideSelectAll, headerColumnStyle = _props3.headerColumnStyle;
          if (hideSelectAll) {
          ...
          return _react2.default.createElement(
            ...
            function(_ref2) {
              ...
              if (selectionHeaderRenderer) {
                ...
                content = _react2.default.createElement(CheckBox, _extends2({}, _this2.props, {
                  checked,
              ...
              return _react2.default.createElement(
                "th",
                _extends2({ className: "selection-cell-header", "data-row-selection": true }, attrs),
                content
              );
            }
          );
...
var require_expand_header_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-expand/expand-header-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var ExpansionHeaderCell = function(_Component) {
      _inherits(ExpansionHeaderCell2, _Component);
      function ExpansionHeaderCell2() {
        _classCallCheck(this, ExpansionHeaderCell2);
        var _this = _possibleConstructorReturn(this, (ExpansionHeaderCell2.__proto__ || Object.getPrototypeOf(ExpansionHeaderCell2)).call(this));
        _this.handleCheckBoxClick = _this.handleCheckBoxClick.bind(_this);
        return _this;
      }
      _createClass(ExpansionHeaderCell2, [{
        key: "handleCheckBoxClick",
        value: function handleCheckBoxClick(e) {
          var _props = this.props, isAnyExpands = _props.isAnyExpands, onAllRowExpand = _props.onAllRowExpand;
          onAllRowExpand(e, !isAnyExpands);
        }
      }, {
        key: "render",
        value: function render() {
          var _props2 = this.props, isAnyExpands = _props2.isAnyExpands, expandHeaderColumnRenderer = _props2.expandHeaderColumnRenderer;
          var attrs = {
            onClick: this.handleCheckBoxClick
          };
          return _react2.default.createElement(
            "th",
            _extends2({ className: "expand-cell-header", "data-row-selection": true }, attrs),
            expandHeaderColumnRenderer ? expandHeaderColumnRenderer({ isAnyExpands }) : isAnyExpands ? "(-)" : "(+)"
          );
        }
      }]);
      return ExpansionHeaderCell2;
    }(_react.Component);
...
var require_rows = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/rows.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.getRowByRowId = exports.matchRow = void 0;
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var matchRow = exports.matchRow = function matchRow2(keyField, id) {
      return function(row) {
        return _utils2.default.get(row, keyField) === id;
      };
    };
    var getRowByRowId = exports.getRowByRowId = function getRowByRowId2(data, keyField, id) {
...
var require_selection = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/selection.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.getSelectedRows = exports.unSelectableKeys = exports.selectableKeys = exports.getSelectionSummary = void 0;
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    var _rows = require_rows();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var getSelectionSummary = exports.getSelectionSummary = function getSelectionSummary2() {
      var data = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
      var keyField = arguments[1];
      var selected = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
    ...
    var selectableKeys = exports.selectableKeys = function selectableKeys2() {
      var data = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
      var keyField = arguments[1];
      var skips = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      if (skips.length === 0) {
    ...
    var unSelectableKeys = exports.unSelectableKeys = function unSelectableKeys2(selected) {
      var skips = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
      if (skips.length === 0) {
        return [];
      }
    ...
    var getSelectedRows = exports.getSelectedRows = function getSelectedRows2() {
      var data = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
      var keyField = arguments[1];
...
var require_expand = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/expand.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var isAnyExpands = exports.isAnyExpands = function isAnyExpands2(data, keyField) {
      var expanded = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      var _loop = function _loop2(i2) {
        var rowKey = _utils2.default.get(data[i2], keyField);
    ...
    var expandableKeys = exports.expandableKeys = function expandableKeys2(data, keyField) {
      var skips = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      if (skips.length === 0) {
        return data.map(function(row) {
          return _utils2.default.get(row, keyField);
    ...
    var getExpandedRows = exports.getExpandedRows = function getExpandedRows2(data, keyField, expanded) {
...
var require_mutate = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/mutate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var editCell = exports.editCell = function editCell2(data, keyField, rowId, dataField, newValue) {
      var row = (0, _rows.getRowByRowId)(data, keyField, rowId);
      if (row)
        _utils2.default.set(row, dataField, newValue);
    };
  }
});
...
var require_sort = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/sort.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var sort = exports.sort = function sort2(data, sortOrder, _ref) {
      var dataField = _ref.dataField, sortFunc = _ref.sortFunc, sortValue = _ref.sortValue;
    ...
    var nextOrder = exports.nextOrder = function nextOrder2(currentSortColumn, _ref2) {
      var sortOrder = _ref2.sortOrder, sortColumn = _ref2.sortColumn;
      var defaultOrder = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : _const2.default.SORT_DESC;
...
var require_type = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/type.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var typeConvert = exports.typeConvert = function typeConvert2(type, value) {
...
var require_operators = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/store/operators.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    exports.default = _extends2({}, rows, selection, expand, mutate, sort, type);
  }
});

// node_modules/react-bootstrap-table-next/lib/src/contexts/selection-context.js
var require_selection_context = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/selection-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var SelectionProvider = function(_React$Component) {
      _inherits(SelectionProvider2, _React$Component);
      function SelectionProvider2(props) {
        _classCallCheck(this, SelectionProvider2);
        var _this = _possibleConstructorReturn(this, (SelectionProvider2.__proto__ || Object.getPrototypeOf(SelectionProvider2)).call(this, props));
        _this.handleRowSelect = function(rowKey, checked, rowIndex, e) {
          var _this$props = _this.props, data = _this$props.data, keyField = _this$props.keyField, _this$props$selectRow = _this$props.selectRow, mode = _this$props$selectRow.mode, onSelect = _this$props$selectRow.onSelect;
          var ROW_SELECT_SINGLE = _const2.default.ROW_SELECT_SINGLE;
        ...
        _this.handleAllRowsSelect = function(e, isUnSelect) {
          var _this$props2 = _this.props, data = _this$props2.data, keyField = _this$props2.keyField, _this$props2$selectRo = _this$props2.selectRow, onSelectAll = _this$props2$selectRo.onSelectAll, nonSelectable = _this$props2$selectRo.nonSelectable;
      ...
      _createClass(SelectionProvider2, [{
        key: "getSelected",
        ...
        key: "render",
        value: function render() {
          var _getSelectionSummary = (0, _selection.getSelectionSummary)(this.props.data, this.props.keyField, this.selected), allRowsSelected = _getSelectionSummary.allRowsSelected, allRowsNotSelected = _getSelectionSummary.allRowsNotSelected;
          var checkedStatus = void 0;
          if (allRowsSelected)
            checkedStatus = _const2.default.CHECKBOX_STATUS_CHECKED;
          else if (allRowsNotSelected)
            checkedStatus = _const2.default.CHECKBOX_STATUS_UNCHECKED;
          else
            checkedStatus = _const2.default.CHECKBOX_STATUS_INDETERMINATE;
          return _react2.default.createElement(
            SelectionContext.Provider,
            {
              value: _extends2({}, this.props.selectRow, {
...
var require_selection_header_cell_consumer = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-selection/selection-header-cell-consumer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _react = require_react();
    var _react2 = _interopRequireDefault(_react);
    var _selectionContext = require_selection_context();
...
var require_row_expand_context = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/row-expand-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var RowExpandProvider = function(_React$Component) {
      _inherits(RowExpandProvider2, _React$Component);
      function RowExpandProvider2() {
        var _ref;
        var _temp, _this, _ret;
        _classCallCheck(this, RowExpandProvider2);
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RowExpandProvider2.__proto__ || Object.getPrototypeOf(RowExpandProvider2)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          ...
          var _this$props = _this.props, data = _this$props.data, keyField = _this$props.keyField, _this$props$expandRow = _this$props.expandRow, onExpand = _this$props$expandRow.onExpand, onlyOneExpanding = _this$props$expandRow.onlyOneExpanding, nonExpandable = _this$props$expandRow.nonExpandable;
          ...
          _this.setState(function() {
            return { expanded: currExpanded, isClosing };
          });
        }, _this.handleAllRowExpand = function(e, expandAll) {
          var _this$props2 = _this.props, data = _this$props2.data, keyField = _this$props2.keyField, _this$props2$expandRo = _this$props2.expandRow, onExpandAll = _this$props2$expandRo.onExpandAll, nonExpandable = _this$props2$expandRo.nonExpandable;
      ...
      _createClass(RowExpandProvider2, [{
        key: "UNSAFE_componentWillReceiveProps",
        value: function UNSAFE_componentWillReceiveProps(nextProps) {
          var _this2 = this;
          if (nextProps.expandRow) {
            var nextExpanded = [].concat(_toConsumableArray(nextProps.expandRow.expanded || this.state.expanded));
            var _nextProps$expandRow$ = nextProps.expandRow.nonExpandable, nonExpandable = _nextProps$expandRow$ === void 0 ? [] : _nextProps$expandRow$;
        ...
        key: "render",
        value: function render() {
          var _props = this.props, data = _props.data, keyField = _props.keyField;
          return _react2.default.createElement(
            RowExpandContext.Provider,
            {
              value: _extends2({}, this.props.expandRow, {
...
var require_expand_header_cell_consumer = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-expand/expand-header-cell-consumer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _react = require_react();
    var _react2 = _interopRequireDefault(_react);
    var _rowExpandContext = require_row_expand_context();
...
var require_header = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/header.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _headerCell = require_header_cell();
    var _headerCell2 = _interopRequireDefault(_headerCell);
    var _selectionHeaderCell = require_selection_header_cell();
    var _selectionHeaderCell2 = _interopRequireDefault(_selectionHeaderCell);
    var _expandHeaderCell = require_expand_header_cell();
    var _expandHeaderCell2 = _interopRequireDefault(_expandHeaderCell);
    var _selectionHeaderCellConsumer = require_selection_header_cell_consumer();
    var _selectionHeaderCellConsumer2 = _interopRequireDefault(_selectionHeaderCellConsumer);
    var _expandHeaderCellConsumer = require_expand_header_cell_consumer();
    ...
    var Header = function Header2(props) {
      var className = props.className, columns = props.columns, onSort = props.onSort, onFilter = props.onFilter, sortField = props.sortField, sortOrder = props.sortOrder, selectRow = props.selectRow, expandRow = props.expandRow, currFilters = props.currFilters, onExternalFilter = props.onExternalFilter, filterPosition = props.filterPosition, globalSortCaret = props.globalSortCaret, wrapperClasses = props.wrapperClasses;
      var SelectionHeaderCellComp = function SelectionHeaderCellComp2() {
        return null;
      };
      var ExpansionHeaderCellComp = function ExpansionHeaderCellComp2() {
        return null;
      };
      ...
      var isRenderFunctionColumnInLeft = function isRenderFunctionColumnInLeft2() {
        var position = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _const2.default.INDICATOR_POSITION_LEFT;
...
var require_filters_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/filters-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var FiltersCell = function FiltersCell2(props) {
      var index = props.index, column = props.column, onExternalFilter = props.onExternalFilter, currFilters = props.currFilters, onFilter = props.onFilter;
      var filterRenderer = column.filterRenderer, filter = column.filter;
      var filterElm = void 0;
      var cellAttrs = {};
      var cellStyle = {};
      cellAttrs.style = cellStyle;
...
var require_row_template = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/row-template.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var RowTemplate = function RowTemplate2(props) {
      var renderContent = props.renderContent, selectRow = props.selectRow, expandRow = props.expandRow, cellEl = props.cellEl, rest = _objectWithoutProperties(props, ["renderContent", "selectRow", "expandRow", "cellEl"]);
      var isRenderFunctionColumnInLeft = function isRenderFunctionColumnInLeft2() {
        var position = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _const2.default.INDICATOR_POSITION_LEFT;
        return position === _const2.default.INDICATOR_POSITION_LEFT;
      };
...
var require_filters = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/filters.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _filtersCell = require_filters_cell();
    var _filtersCell2 = _interopRequireDefault(_filtersCell);
    var _const = require_const();
    var _const2 = _interopRequireDefault(_const);
    var _rowTemplate = require_row_template();
    var _rowTemplate2 = _interopRequireDefault(_rowTemplate);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var Filters = function Filters2(props) {
      var columns = props.columns, onFilter = props.onFilter, currFilters = props.currFilters, filterPosition = props.filterPosition, onExternalFilter = props.onExternalFilter, className = props.className, selectRow = props.selectRow, expandRow = props.expandRow;
...
var require_caption = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/caption.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Caption = function Caption2(props) {
      if (!props.children)
        return null;
...
var require_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Cell = function(_eventDelegater) {
      _inherits(Cell2, _eventDelegater);
      function Cell2(props) {
        _classCallCheck(this, Cell2);
        var _this = _possibleConstructorReturn(this, (Cell2.__proto__ || Object.getPrototypeOf(Cell2)).call(this, props));
        _this.createHandleEditingCell = function(originFunc) {
          return function(e) {
            var _this$props = _this.props, onStart = _this$props.onStart, rowIndex = _this$props.rowIndex, columnIndex = _this$props.columnIndex, clickToEdit = _this$props.clickToEdit, dbclickToEdit = _this$props.dbclickToEdit;
      ...
      _createClass(Cell2, [{
        ...
        key: "render",
        value: function render() {
          var _props = this.props, row = _props.row, rowIndex = _props.rowIndex, column = _props.column, columnIndex = _props.columnIndex, onStart = _props.onStart, editable = _props.editable, clickToEdit = _props.clickToEdit, dbclickToEdit = _props.dbclickToEdit, rest = _objectWithoutProperties(_props, ["row", "rowIndex", "column", "columnIndex", "onStart", "editable", "clickToEdit", "dbclickToEdit"]);
          var dataField = column.dataField, formatter = column.formatter, formatExtraData = column.formatExtraData;
          var attrs = this.delegate(_extends2({}, rest));
...
var require_row_pure_content = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/row-pure-content.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var RowPureContent = function(_React$Component) {
      _inherits(RowPureContent2, _React$Component);
      function RowPureContent2() {
        _classCallCheck(this, RowPureContent2);
        return _possibleConstructorReturn(this, (RowPureContent2.__proto__ || Object.getPrototypeOf(RowPureContent2)).apply(this, arguments));
      }
      _createClass(RowPureContent2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
        ...
        key: "render",
        value: function render() {
          var _props = this.props, row = _props.row, keyField = _props.keyField, columns = _props.columns, rowIndex = _props.rowIndex, editable = _props.editable, editingRowIdx = _props.editingRowIdx, editingColIdx = _props.editingColIdx, onStart = _props.onStart, clickToEdit = _props.clickToEdit, dbclickToEdit = _props.dbclickToEdit, EditingCellComponent = _props.EditingCellComponent, tabIndexStart = _props.tabIndexStart;
          ...
          return columns.map(function(column, index) {
            ...
            var cellStyle = {};
            var cellAttrs = _extends2({}, _utils2.default.isFunction(column.attrs) ? column.attrs(content, row, rowIndex, index) : column.attrs);
            if (column.events) {
              ...
              cellAttrs = _extends2({}, cellAttrs, events);
            }
            ...
            if (column.dataField === keyField || !editable)
              editableCell = false;
            ...
            return _react2.default.createElement(_cell2.default, _extends2({
              key: content + "-" + index,
              row,
...
var require_event_delegater = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/event-delegater.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return function(_ExtendBase) {
        ...
        _createClass(RowEventDelegater, [{
          ...
          value: function createClickEventHandler(cb) {
            var _this2 = this;
            return function(e) {
              var _props = _this2.props, row = _props.row, selected = _props.selected, keyField = _props.keyField, selectable = _props.selectable, expandable = _props.expandable, rowIndex = _props.rowIndex, expanded = _props.expanded, expandRow = _props.expandRow, selectRow = _props.selectRow, DELAY_FOR_DBCLICK = _props.DELAY_FOR_DBCLICK;
              var clickFn = function clickFn2() {
                if (cb) {
                  cb(e, row, rowIndex);
                }
          ...
          value: function createDefaultEventHandler(cb) {
            var _this3 = this;
            return function(e) {
              var _props2 = _this3.props, row = _props2.row, rowIndex = _props2.rowIndex;
              cb(e, row, rowIndex);
            };
          }
        }, {
...
var require_should_updater = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/should-updater.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return function(_ExtendBase) {
        ...
        _createClass(RowShouldUpdater, [{
          ...
          value: function shouldUpdateByCellEditing(nextProps) {
            if (!(this.props.clickToEdit || this.props.dbclickToEdit))
              return false;
...
var require_simple_row = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/simple-row.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _rowPureContent = require_row_pure_content();
    var _rowPureContent2 = _interopRequireDefault(_rowPureContent);
    var _eventDelegater = require_event_delegater();
    var _eventDelegater2 = _interopRequireDefault(_eventDelegater);
    var _shouldUpdater2 = require_should_updater();
    ...
    var SimpleRow = function(_shouldUpdater) {
      _inherits(SimpleRow2, _shouldUpdater);
      function SimpleRow2(props) {
        _classCallCheck(this, SimpleRow2);
        var _this = _possibleConstructorReturn(this, (SimpleRow2.__proto__ || Object.getPrototypeOf(SimpleRow2)).call(this, props));
        _this.shouldUpdateRowContent = false;
        return _this;
      }
      _createClass(SimpleRow2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
          this.shouldUpdateRowContent = false;
          this.shouldUpdateRowContent = this.shouldRowContentUpdate(nextProps);
          if (this.shouldUpdateRowContent)
            return true;
        ...
        key: "render",
        value: function render() {
          var _props = this.props, className = _props.className, style = _props.style, attrs = _props.attrs, visibleColumnSize = _props.visibleColumnSize, tabIndexCell = _props.tabIndexCell, rest = _objectWithoutProperties(_props, ["className", "style", "attrs", "visibleColumnSize", "tabIndexCell"]);
          var trAttrs = this.delegate(attrs);
          var tabIndexStart = this.props.rowIndex * visibleColumnSize + 1;
          return _react2.default.createElement(
            "tr",
            _extends2({ style, className }, trAttrs),
            _react2.default.createElement(_rowPureContent2.default, _extends2({
...
var require_expand_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-expand/expand-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var ExpandCell = function(_Component) {
      _inherits(ExpandCell2, _Component);
      function ExpandCell2() {
        _classCallCheck(this, ExpandCell2);
        var _this = _possibleConstructorReturn(this, (ExpandCell2.__proto__ || Object.getPrototypeOf(ExpandCell2)).call(this));
        _this.handleClick = _this.handleClick.bind(_this);
        return _this;
      }
      _createClass(ExpandCell2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
        ...
        value: function handleClick(e) {
          var _props = this.props, rowKey = _props.rowKey, expanded = _props.expanded, onRowExpand = _props.onRowExpand, rowIndex = _props.rowIndex;
          e.stopPropagation();
        ...
        key: "render",
        value: function render() {
          var _props2 = this.props, expanded = _props2.expanded, expandable = _props2.expandable, expandColumnRenderer = _props2.expandColumnRenderer, tabIndex = _props2.tabIndex, rowKey = _props2.rowKey;
          var attrs = {};
          if (tabIndex !== -1)
            attrs.tabIndex = tabIndex;
          return _react2.default.createElement(
            "td",
            _extends2({ className: "expand-cell", onClick: this.handleClick }, attrs),
...
var require_selection_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-selection/selection-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var SelectionCell = function(_Component) {
      _inherits(SelectionCell2, _Component);
      function SelectionCell2() {
        _classCallCheck(this, SelectionCell2);
        var _this = _possibleConstructorReturn(this, (SelectionCell2.__proto__ || Object.getPrototypeOf(SelectionCell2)).call(this));
        _this.handleClick = _this.handleClick.bind(_this);
        return _this;
      }
      _createClass(SelectionCell2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
        ...
        key: "handleClick",
        value: function handleClick(e) {
          var _props = this.props, inputType = _props.mode, rowKey = _props.rowKey, selected = _props.selected, onRowSelect = _props.onRowSelect, disabled = _props.disabled, rowIndex = _props.rowIndex;
          e.stopPropagation();
          if (disabled)
            return;
        ...
        value: function render() {
          var _this2 = this;
          var _props2 = this.props, rowKey = _props2.rowKey, inputType = _props2.mode, selected = _props2.selected, disabled = _props2.disabled, tabIndex = _props2.tabIndex, rowIndex = _props2.rowIndex, selectionRenderer = _props2.selectionRenderer, selectColumnStyle = _props2.selectColumnStyle;
          var attrs = {};
          if (tabIndex !== -1)
            attrs.tabIndex = tabIndex;
          ...
          return _react2.default.createElement(
            ...
            function(_ref) {
              ...
              return _react2.default.createElement(
                "td",
                _extends2({ className: "selection-cell", onClick: _this2.handleClick }, attrs),
...
var require_aggregate_row = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/aggregate-row.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    var _expandCell = require_expand_cell();
    var _expandCell2 = _interopRequireDefault(_expandCell);
    var _selectionCell = require_selection_cell();
    ...
    var RowAggregator = function(_shouldUpdater) {
      _inherits(RowAggregator2, _shouldUpdater);
      function RowAggregator2(props) {
        _classCallCheck(this, RowAggregator2);
        var _this = _possibleConstructorReturn(this, (RowAggregator2.__proto__ || Object.getPrototypeOf(RowAggregator2)).call(this, props));
        _this.clickNum = 0;
        _this.shouldUpdateRowContent = false;
        _this.createClickEventHandler = _this.createClickEventHandler.bind(_this);
        return _this;
      }
      _createClass(RowAggregator2, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps) {
        ...
        key: "render",
        value: function render() {
          var _props = this.props, row = _props.row, columns = _props.columns, keyField = _props.keyField, rowIndex = _props.rowIndex, style = _props.style, className = _props.className, attrs = _props.attrs, selectRow = _props.selectRow, expandRow = _props.expandRow, expanded = _props.expanded, expandable = _props.expandable, selected = _props.selected, selectable = _props.selectable, visibleColumnSize = _props.visibleColumnSize, tabIndexCell = _props.tabIndexCell, rest = _objectWithoutProperties(_props, ["row", "columns", "keyField", "rowIndex", "style", "className", "attrs", "selectRow", "expandRow", "expanded", "expandable", "selected", "selectable", "visibleColumnSize", "tabIndexCell"]);
          var key = _utils2.default.get(row, keyField);
          var hideSelectColumn = selectRow.hideSelectColumn, selectColumnPosition = selectRow.selectColumnPosition, clickToSelect = selectRow.clickToSelect;
          var showExpandColumn = expandRow.showExpandColumn, expandColumnPosition = expandRow.expandColumnPosition;
          var newAttrs = this.delegate(_extends2({}, attrs));
          if (clickToSelect || !!expandRow.renderer) {
            newAttrs.onClick = this.createClickEventHandler(newAttrs.onClick);
          }
          var tabIndexStart = rowIndex * visibleColumnSize + 1;
          var childrens = [_react2.default.createElement(_rowPureContent2.default, _extends2({
            key: "row",
            row,
            columns,
            keyField,
          ...
          if (!hideSelectColumn) {
            var selectCell = _react2.default.createElement(_selectionCell2.default, _extends2({}, selectRow, {
              key: "selection-cell",
              rowKey: key,
              rowIndex,
              selected,
          ...
          if (showExpandColumn) {
            var expandCell = _react2.default.createElement(_expandCell2.default, _extends2({}, expandRow, {
              key: "expand-cell",
              rowKey: key,
              rowIndex,
              expanded,
...
var require_row_section = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row/row-section.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var RowSection = function RowSection2(_ref) {
      var content = _ref.content, colSpan = _ref.colSpan;
      return _react2.default.createElement(
        "tr",
        null,
        _react2.default.createElement(
...
var require_row_consumer = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-selection/row-consumer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    exports.default = function(Component) {
      var renderWithSelection = function renderWithSelection2(props, selectRow) {
        var key = props.value;
        ...
        var style = props.style, className = props.className;
        if (selected) {
          ...
          style = _extends2({}, style, selectedStyle);
          className = (0, _classnames2.default)(className, selectedClasses) || void 0;
        ...
        if (notSelectable) {
          ...
          style = _extends2({}, style, notSelectableStyle);
          className = (0, _classnames2.default)(className, notSelectableClasses) || void 0;
        }
        return _react2.default.createElement(Component, _extends2({}, props, {
          style,
          className,
          selectRow,
          selected,
...
var require_expand_row = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-expand/expand-row.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var ExpandRow = function ExpandRow2(_ref) {
      var children2 = _ref.children, expanded = _ref.expanded, onClosed = _ref.onClosed, className = _ref.className, rest = _objectWithoutProperties(_ref, ["children", "expanded", "onClosed", "className"]);
      return _react2.default.createElement(
        "tr",
        null,
        _react2.default.createElement(
          "td",
          _extends2({ className: (0, _classnames2.default)("reset-expansion-style", className) }, rest),
          _react2.default.createElement(
...
var require_row_consumer2 = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/row-expand/row-consumer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _classnames = require_classnames();
    var _classnames2 = _interopRequireDefault(_classnames);
    var _expandRow = require_expand_row();
    ...
    exports.default = function(Component) {
      var renderWithExpansion = function renderWithExpansion2(props, expandRow) {
        var parentClassName = "";
        var className = "";
        var key = props.value;
...
var require_body = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/body.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Body = function(_React$Component) {
      ...
      function Body2(props) {
        ...
        var keyField = props.keyField, cellEdit = props.cellEdit, selectRow = props.selectRow, expandRow = props.expandRow;
      ...
      _createClass(Body2, [{
        ...
        value: function render() {
          var _this2 = this;
          var _props = this.props, columns = _props.columns, data = _props.data, tabIndexCell = _props.tabIndexCell, keyField = _props.keyField, isEmpty = _props.isEmpty, noDataIndication = _props.noDataIndication, visibleColumnSize = _props.visibleColumnSize, cellEdit = _props.cellEdit, selectRow = _props.selectRow, rowStyle = _props.rowStyle, rowClasses = _props.rowClasses, rowEvents = _props.rowEvents, expandRow = _props.expandRow, className = _props.className;
          var content = void 0;
          if (isEmpty) {
...
var require_footer_cell = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/footer-cell.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var FooterCell = function(_eventDelegater) {
      _inherits(FooterCell2, _eventDelegater);
      function FooterCell2() {
        _classCallCheck(this, FooterCell2);
        return _possibleConstructorReturn(this, (FooterCell2.__proto__ || Object.getPrototypeOf(FooterCell2)).apply(this, arguments));
      }
      _createClass(FooterCell2, [{
        key: "render",
        value: function render() {
          var _props = this.props, index = _props.index, column = _props.column, columnData = _props.columnData;
          var footer = column.footer, footerTitle = column.footerTitle, footerAlign = column.footerAlign, footerFormatter = column.footerFormatter, footerEvents = column.footerEvents, footerClasses = column.footerClasses, footerStyle = column.footerStyle, footerAttrs = column.footerAttrs;
          var delegateEvents = this.delegate(footerEvents);
          var cellAttrs = _extends2({}, _utils2.default.isFunction(footerAttrs) ? footerAttrs(column, index) : footerAttrs, delegateEvents);
          var text = "";
          ...
          if (!_utils2.default.isEmptyObject(cellStyle))
            cellAttrs.style = cellStyle;
          var children2 = footerFormatter ? footerFormatter(column, index, { text }) : text;
          return _react2.default.createElement("th", cellAttrs, children2);
        }
      }]);
      return FooterCell2;
...
var require_footer = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/footer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _rowTemplate = require_row_template();
    var _rowTemplate2 = _interopRequireDefault(_rowTemplate);
    var _footerCell = require_footer_cell();
    ...
    var Footer = function Footer2(props) {
      var data = props.data, className = props.className, columns = props.columns, selectRow = props.selectRow, expandRow = props.expandRow;
      function renderContent() {
        return columns.map(function(column, i) {
          if (column.footer === void 0 || column.footer === null) {
            return false;
          }
...
var require_column_resolver = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/props-resolver/column-resolver.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return function(_ExtendBase) {
        ...
        _createClass(ColumnResolver, [{
          ...
          value: function visibleColumnSize() {
            var includeSelectColumn = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
...
var require_props_resolver = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/props-resolver/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    var _columnResolver = require_column_resolver();
      ...
      return function(_ColumnResolver) {
        ...
        _createClass(TableResolver, [{
          ...
          value: function visibleRows() {
            var _props = this.props, data = _props.data, hiddenRows = _props.hiddenRows, keyField = _props.keyField;
...
var require_bootstrap_table = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/bootstrap-table.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propsResolver = require_props_resolver();
    ...
    var BootstrapTable = function(_PropsBaseResolver) {
      _inherits(BootstrapTable2, _PropsBaseResolver);
      function BootstrapTable2(props) {
        _classCallCheck(this, BootstrapTable2);
        var _this = _possibleConstructorReturn(this, (BootstrapTable2.__proto__ || Object.getPrototypeOf(BootstrapTable2)).call(this, props));
      ...
      _createClass(BootstrapTable2, [{
        ...
        key: "render",
        value: function render() {
          var _props = this.props, loading = _props.loading, overlay = _props.overlay;
          if (overlay) {
...
var require_data_context = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/data-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    exports.default = function() {
      ...
      var DataProvider = function(_Component) {
        _inherits(DataProvider2, _Component);
        function DataProvider2() {
          var _ref;
          var _temp, _this, _ret;
          _classCallCheck(this, DataProvider2);
          for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataProvider2.__proto__ || Object.getPrototypeOf(DataProvider2)).call.apply(_ref, [this].concat(args))), _this), _this.state = { data: _this.props.data }, _this.getData = function(filterProps, searchProps, sortProps, paginationProps) {
            if (paginationProps)
...
var require_column_context = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/column-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    exports.default = function() {
      ...
      var ColumnManagementProvider = function(_React$Component) {
        _inherits(ColumnManagementProvider2, _React$Component);
        function ColumnManagementProvider2() {
          _classCallCheck(this, ColumnManagementProvider2);
          return _possibleConstructorReturn(this, (ColumnManagementProvider2.__proto__ || Object.getPrototypeOf(ColumnManagementProvider2)).apply(this, arguments));
        }
        _createClass(ColumnManagementProvider2, [{
          key: "render",
          value: function render() {
            var toggleColumn = void 0;
            var _props = this.props, columns = _props.columns, toggles = _props.toggles;
            if (toggles) {
        ...
        return ColumnManagementProvider2;
      }(_react2.default.Component);
...
var require_sort_context = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/sort-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    exports.default = function(dataOperator, isRemoteSort, handleSortChange) {
      ...
      var SortProvider = function(_React$Component) {
        _inherits(SortProvider2, _React$Component);
        function SortProvider2(props) {
          _classCallCheck(this, SortProvider2);
          var _this = _possibleConstructorReturn(this, (SortProvider2.__proto__ || Object.getPrototypeOf(SortProvider2)).call(this, props));
          _initialiseProps.call(_this);
          var sortOrder = void 0;
          var sortColumn = void 0;
          var defaultSorted = props.defaultSorted, defaultSortDirection = props.defaultSortDirection, sort = props.sort;
          ...
          _this.state = { sortOrder, sortColumn };
          return _this;
        }
        _createClass(SortProvider2, [{
          ...
          key: "UNSAFE_componentWillReceiveProps",
          value: function UNSAFE_componentWillReceiveProps(nextProps) {
            var sort = nextProps.sort, columns = nextProps.columns;
          ...
          value: function render() {
            ...
            var _state2 = this.state, sortOrder = _state2.sortOrder, sortColumn = _state2.sortColumn;
            if (!isRemoteSort() && sortColumn) {
              var sortFunc = sortColumn.sortFunc ? sortColumn.sortFunc : sort && sort.sortFunc;
              data = dataOperator.sort(data, sortOrder, _extends2({}, sortColumn, { sortFunc }));
            }
            return _react2.default.createElement(
...
var require_remote_resolver = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/props-resolver/remote-resolver.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return function(_ExtendBase) {
        ...
        function RemoteResolver(props) {
          ...
          _this.handleRemotePageChange = function(page, sizePerPage) {
            _this.props.onTableChange("pagination", _this.getNewestState({ page, sizePerPage }));
          };
          ...
          _this.handleRemoteSortChange = function(sortField, sortOrder) {
            _this.props.onTableChange("sort", _this.getNewestState({ sortField, sortOrder }));
          };
          _this.handleRemoteCellChange = function(rowId, dataField, newValue) {
            var cellEdit = { rowId, dataField, newValue };
            _this.props.onTableChange("cellEdit", _this.getNewestState({ cellEdit }));
          };
          _this.handleRemoteSearchChange = function(searchText) {
            _this.props.onTableChange("search", _this.getNewestState({ searchText }));
          };
...
var require_contexts = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/src/contexts/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _utils = require_utils();
    var _utils2 = _interopRequireDefault(_utils);
    var _dataContext = require_data_context();
    var _dataContext2 = _interopRequireDefault(_dataContext);
    var _columnContext = require_column_context();
    var _columnContext2 = _interopRequireDefault(_columnContext);
    var _sortContext = require_sort_context();
    var _sortContext2 = _interopRequireDefault(_sortContext);
    var _selectionContext = require_selection_context();
    var _selectionContext2 = _interopRequireDefault(_selectionContext);
    var _rowExpandContext = require_row_expand_context();
    var _rowExpandContext2 = _interopRequireDefault(_rowExpandContext);
    var _remoteResolver2 = require_remote_resolver();
    ...
    var withContext = function withContext2(Base) {
        ...
        _createClass(BootstrapTableContainer, [{
          ...
          value: function renderBase() {
            ...
            return function(rootProps, filterProps, searchProps, sortProps, paginationProps, columnToggleProps) {
              return _react2.default.createElement(Base, _extends2({
                ref: function ref(n) {
          ...
          key: "render",
          value: function render() {
            var _props = this.props, keyField = _props.keyField, columns = _props.columns, bootstrap4 = _props.bootstrap4;
            var baseProps = { keyField, columns };
...
var require_lib = __commonJS({
  "node_modules/react-bootstrap-table-next/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _bootstrapTable = require_bootstrap_table();
    var _bootstrapTable2 = _interopRequireDefault(_bootstrapTable);
    var _contexts = require_contexts();
